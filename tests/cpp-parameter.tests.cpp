...
TEST_CASE("CppParameter", "[CppParameter]")
{
    SECTION("TODO")
    {
        ...
        CHECK(to_string(cppParameter, Declaration | Definition) == to_string(cppParameter, Declaration));
    }
    SECTION("TODO")
    {
...
TEST_CASE("CppParameter::Collection", "[CppParameter::Collection]")
{
    SECTION("TODO")
    {
        ...
        CHECK(to_string(cppParameters, Declaration | Definition) == to_string(cppParameters, Declaration));
    }
    SECTION("TODO")
    {
